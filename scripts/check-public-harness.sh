...
28	2624	CCX	src/point_add/trailmix_ludicrous/mcx.rs	80	none	4ccf2146ceb1eb50
29	2556	CCX	src/point_add/trailmix_ludicrous/fused.rs	832	none	30dc96d7748fab35
30	24512	CCX	src/point_add/trailmix_ludicrous/square.rs	154	none	5db1c7a68cd9a333
31	24512	CCX	src/point_add/trailmix_ludicrous/square.rs	183	none	dfd7339142550728
EOF
if ! python3 scripts/storm-exact-miner.py trace-facts \
  ...
  fail=1
elif ! grep -q 'counterexample=31' "$tmpdir/source-hash-bound-scout-supported.out" ||
